...
**Repository settings required before this runs:** the repository must be **public**
(MATLAB licensing, spec §3.1) and Pages must be set to "GitHub Actions" as its source.
    ...
    steps:
      ...
      - name: Carry the drift log forward and append this run
        run: |
          ...
          curl -fsSL "https://${{ github.repository_owner }}.github.io/${{ github.event.repository.name }}/data/history.jsonl" \
